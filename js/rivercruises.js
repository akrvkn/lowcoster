            ...
            "columnDefs": [
                ...
                },
                {
                    "render": function ( data, type, row ) {
                            ...
                            return "<a class='button btn-small' href='"+ booking_url + row.tourid+'&ship='+row['ship-id'] + "' target='_blank'>ПОДРОБНЕЕ</a>";
